...
def effect(BHE,BHN,BLE,BLN,new_bhe,new_bhn):
    ...
    fig = plt.figure("Raw data of E-W component")
    axs = fig.subplots()
    ...
    fig = plt.figure("Raw data of N-S component")
    axs = fig.subplots()
    ...
    fig = plt.figure("Comparison of corrected BHE data and raw BLE data")
    axs = fig.subplots()
    axs.set_title("Corrected BHE data VS Raw BLE data")
    axs.set_ylabel("count")
    axs.grid(True)
    ...
    fig = plt.figure("Comparison of corrected BHN data and raw BLN data")
    axs = fig.subplots()
    axs.grid(True)
    axs.set_title("Corrected BHN data VS Raw BLN data")
    axs.set_ylabel("count")
...
def additional_effect(BLE,BLN,new_bhe,new_bhn):
    ...
    fig= plt.figure("Comparison of corrected BHE data and raw BLE data after filter")
    axs = fig.subplots()
    axs.grid(True)
    ...
    fig = plt.figure("Comparison of corrected BHN data and raw BLN data after filter")
    axs = fig.subplots()
    axs.grid(True)
