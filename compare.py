...
axs[0].legend(["Correcred BHE data by Holcomb's method"],loc="upper right",fontsize=8)
axs[1].legend(["Correcred BHE data by Ringler's method"],loc="upper right",fontsize=8)
axs[2].legend(["Correcred BHE data by proposed method"],loc="upper right",fontsize=8)
axs[3].legend(["BLE data "],loc="upper right",fontsize=8)
...
axs[0].legend([r"Correcred BHN data by Holcomb's method"],loc="upper right",fontsize=8)
axs[1].legend([r"Correcred BHN data by Ringler's method"],loc="upper right",fontsize=8)
axs[2].legend([r"Correcred BHN data by proposed method"],loc="upper right",fontsize=8)
axs[3].legend(["BLN data"],loc="upper right",fontsize=8)
plt.tight_layout()
plt.show()
